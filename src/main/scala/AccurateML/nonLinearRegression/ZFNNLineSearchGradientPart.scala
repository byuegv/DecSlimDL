...
/**
  ...
  */
class ZFNNLineSearchGradientPart(fitmodel: NonlinearModel, xydata: RDD[(Double, Vector)], r: Double,redisHost:String) extends SumOfSquaresFunction with Serializable{
...
object ZFNNLineSearchGradientPart {
  def main(args: Array[String]) {
    ...
    for (r <- ratioL) {
      ...
      val modelTrain: ZFNNLineSearchGradientPart = new ZFNNLineSearchGradientPart(model, train, ratio,redisHost)
