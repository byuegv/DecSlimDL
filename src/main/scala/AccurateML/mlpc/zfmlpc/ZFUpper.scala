...
/**
  ...
  */
@DeveloperApi
abstract class ZFUpdater extends Serializable {
  /**
...
/**
  ...
  */
@DeveloperApi
class ZFSimpleUpdater extends ZFUpdater {
...
/**
  * :: DeveloperApi ::
  * ZFUpdater for L1 regularized problems.
  *          R(w) = ||w||_1
  * Uses a step-size decreasing with the square root of the number of iterations.
  *
  ...
  */
@DeveloperApi
class ZFL1Updater extends ZFUpdater {
  override def compute(
                        weightsOld: Vector,
                        gradient: Vector,
                        stepSize: Double,
...
/**
  * :: DeveloperApi ::
  * ZFUpdater for L2 regularized problems.
  *          R(w) = 1/2 ||w||^2
  * Uses a step-size decreasing with the square root of the number of iterations.
  */
@DeveloperApi
class ZFSquaredL2Updater extends ZFUpdater {
  override def compute(
                        weightsOld: Vector,
                        gradient: Vector,
                        stepSize: Double,
