...
class RemvControler extends Serializable {
  ...
  var fullGradients: Boolean = false
  ...
  def this(isExtraCompute: Boolean,layerName: String,gradName: String,fullGradients: Boolean,removeCriterion: String,
           isTaskRemove: Boolean,taskStrategy: String,taskFraction: Double){
    this()
    this.isExtraCompute = isExtraCompute
    ...
    this.layerName = layerName
    this.gradName = gradName
    this.fullGradients = fullGradients
