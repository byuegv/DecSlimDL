package slpart.models.gossipgrad.alexnet
...
import slpart.models.alexnet.AlexNetCifar10Thinner4
import wxw.dataloader.AggCIFAR10

object TrainCifar10Thinner4 {
  ...
  def main(args: Array[String]): Unit = {
    trainParser.parse(args,new TrainParams()).map(param =>{
      ...
      val model = if(param.loadSnapshot && param.model.isDefined){
        ...
        AlexNetCifar10Thinner4(param.classes,hasDropout = param.hasDropout,hasbn = param.hasBN)
      }
